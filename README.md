...
Считаю что для текущего масштаба этого достаточно, но для развития такая архитектура затруднит развитие. Добавление сущности - это создание структуры для обмена данными обработчик запроса - БД, и набора функций обработчика и БД. Для операций CRUD четыре структуры и восемь новых функций.
